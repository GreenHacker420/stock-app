  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black tracking-tight">New Order Booking</h1>
          <p className="text-xs text-muted-foreground">Book customer advance order for packing and delivery (Ctrl+F8).</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            <CardTitle className="text-sm font-bold">Ordered Items</CardTitle>
          ...
          <CardFooter className="flex justify-between items-center bg-muted/30 pt-4">
            <div className="text-sm font-black">Total: {formatINR(totalAmount)}</div>
